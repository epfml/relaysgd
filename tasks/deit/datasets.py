...
def build_dataset(is_train, data_set, data_path, inat_category=None, input_size=224, color_jitter=0.4, aa="rand-m9-mstd0.5-inc1", train_interpolation="bicubic", reprob=0.25, remode="pixel", recount=1):
    ...
    if data_set == 'CIFAR':
        ...
        dataset = INatDataset(data_path, train=is_train, year=2018,
                              category=inat_category, transform=transform)
        nb_classes = dataset.nb_classes
    elif data_set == 'INAT19':
        dataset = INatDataset(data_path, train=is_train, year=2019,
                              category=inat_category, transform=transform)
        nb_classes = dataset.nb_classes
