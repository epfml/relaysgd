...
"""
Code taken from
Koloskova and Lin et al. 2020. Decentralized Deep Learning with Arbitrary Communication Compression
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, stride=1, downsample=None):
        ...
        self.conv3 = nn.Conv2d(
            in_channels=out_planes, out_channels=out_planes * 4, kernel_size=1, bias=False
        )
