...
description = "Testing if D2 can tollerate randomly dropping messages"
...
for drop_prob in [0, 0.1, 0.01]:
    config = {**base_config, "simulated_dropped_message_probability": drop_prob}
    job_name = "{algorithm}-{learning_rate}-drop{simulated_dropped_message_probability}".format(**config)
